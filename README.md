...
> <svg class="svg-icon"><use xlink:href="{{ '/assets/icn/minima-social-icons.svg#github' | relative_url }}"></use></svg> [ThinkJava2 repository on GitHub](https://github.com/ChrisMayfield/ThinkJava2)
